              ...
              itemBuilder: (_, i) => _DoctorCard(
                ...
                onBook: () {
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (_) => DermatologyDoctorScheduleScreen(
                        doctor: doctors[i],
                      ),
                    ),
                  );
...
class DermatologyDoctorScheduleScreen extends StatefulWidget {
  const DermatologyDoctorScheduleScreen({
    required this.doctor,
    super.key,
  });
  ...
  @override
  State<DermatologyDoctorScheduleScreen> createState() =>
      _DermatologyDoctorScheduleScreenState();
}

class _DermatologyDoctorScheduleScreenState
    extends State<DermatologyDoctorScheduleScreen> {
  bool _dayTomorrow = true; // default active like screenshot
